                    ...
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        ...
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Testimony Photo</a>
                                </li>
                ...
                <div class="col-xxl-9">
                    <div class="card mt-xxl-n5">
                            ...
                            <ul class="nav nav-tabs-custom rounded card-header-tabs border-bottom-0" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" data-bs-toggle="tab" href="#personalDetails" role="tab"
                                        aria-selected="false">
                                        <i class="fas fa-home"></i> Edit Testimony Photo
                                    </a>
                                </li>
                        ...
                        if (isset($_POST['save'])) {
                            ...
                            if ($status == "OK") {
                                $qb = mysqli_query($con, "update testimony set ufile='$new_file_name' where id='$todo'");


                                if ($qb) {
                                    $errormsg = "
<div class='alert alert-success alert-dismissible alert-outline fade show'>
                 Testimony Photo Updated successfully.
