                                ...
                                <div class="tab-pane active" id="personalDetails" role="tabpanel">
                                    ...
                                    <form action="" method="post" enctype="multipart/form-data">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="firstnameInput"
                                                        name="why_title" value="<?php print $why_title ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="mb-3">
                                                    ...
                                                    <textarea class="form-control" id="exampleFormControlTextarea5"
                                                        name="why_text" rows="2"><?php print $why_text ?></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="mb-3">
                                                    <label for="firstnameInput" class="form-label"> Testimonial
                                                        Title</label>
                                                    <input type="text" class="form-control" id="firstnameInput"
                                                        name="test_title" value="<?php print $test_title ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="mb-3">
                                                    <label for="firstnameInput" class="form-label"> Testimonial
                                                        Text</label>
                                                    <textarea class="form-control" id="exampleFormControlTextarea5"
                                                        name="test_text" rows="2"><?php print $test_text ?></textarea>
                                                </div>
                                            </div>

                                            <div class="col-lg-6">
                                                <div class="mb-3">
                                                    <label for="firstnameInput" class="form-label"> Contact Us
                                                        Title</label>
                                                    <input type="text" class="form-control" id="firstnameInput"
                                                        name="contact_title" value="<?php print $contact_title ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="mb-3">
                                                    ...
                                                    <textarea class="form-control" id="exampleFormControlTextarea5"
                                                        name="contact_text"
                                                        rows="2"><?php print $contact_text ?></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="firstnameInput"
                                                        name="enquiry_title" value="<?php print $enquiry_title ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="mb-3">
                                                    ...
                                                    <textarea class="form-control" id="exampleFormControlTextarea5"
                                                        name="enquiry_text"
                                                        rows="2"><?php print $enquiry_text ?></textarea>
                                                </div>
                                            </div>
