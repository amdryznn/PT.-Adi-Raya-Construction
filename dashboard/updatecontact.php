                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="firstnameInput"
                                                        name="phone1" value="<?php print $phone1 ?>">
                                                </div>
                                            </div>

                                            <div class="col-lg-6">
                                                <div class="mb-3">
                                                    <label for="firstnameInput" class="form-label"> Alternative
                                                        Phone</label>
                                                    <input type="text" class="form-control" id="firstnameInput"
                                                        name="phone2" value="<?php print $phone2 ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="firstnameInput"
                                                        name="email1" value="<?php print $email1 ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="mb-3">
                                                    <label for="firstnameInput" class="form-label"> Alternative
                                                        Email</label>
                                                    <input type="text" class="form-control" id="firstnameInput"
                                                        name="email2" value="<?php print $email2 ?>">
                                                </div>
                                            </div>
